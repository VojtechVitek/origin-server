...
* link:https://www.openshift.com/walkthrough/how-it-works[How It Works]
* link:https://www.openshift.com/walkthrough/developer-workflow[Developer Workflow]
* link:origin_hangouts.html[Origin On-Air Hangouts]

== Development

[cols="2*<.<1d",options="header"]
|===
|Application Developer Guides
|Cartridge Developer Guides

a|link:oo_user_guide.html[User Guide] +
link:oo_client_tools_installation_guide.html[Client Tools Installation Guide] +
link:oo_cartridge_guide.html[Cartridge Guide]

a|link:oo_contributors_guide.html[OpenShift Contributors Guide] +
link:oo_cartridge_developers_guide.html[Cartridge Developers Guide] +
link:rest_api/rest-api-1-6.html[Broker REST API] +
link:oo_notes_building_rpms_from_source.html[Notes on Building from Source]
...
a|link:oo_install_users_guide.html[*oo-install* User's Guide] +
link:oo_deployment_guide_comprehensive.html[Comprehensive Deployment Guide] +
link:oo_deployment_guide_puppet.html[Puppet Deployment Guide] +
link:oo_deployment_guide_vagrant.html[Vagrant Deployment Guide] +
...
link:oo_notes_running_a_local_ddns.html[Notes on Running a Local DNS]
