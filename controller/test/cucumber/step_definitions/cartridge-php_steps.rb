...
Then /^the php file permissions are correct/ do
  ...
  configure_files = {
    ...
    "php/configuration/etc/php.d/[^_]*" => ['root', gear_uuid, '100644', se_context],
    "php/configuration/etc/php.d/_*" => [gear_uuid, gear_uuid, '100644', se_context],
    ...
    ".drush/" => [gear_uuid, gear_uuid, '100755', se_context],
  }
